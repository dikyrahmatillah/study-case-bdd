...
export default function StudioSection() {
  return (
    <section className="flex flex-col items-center pt-25 pb-30 px-0 max-[750px]:pt-12.5 max-[750px]:pb-7.5 max-[750px]:px-4 border-b-2 border-[#222222]">
      ...
      <div className="max-w-112.5 mx-auto text-center text-[#222222] text-[16px] font-light leading-6 mb-12.5 max-[750px]:text-[15px] max-[750px]:leading-5.5 max-[750px]:mb-7.5">
